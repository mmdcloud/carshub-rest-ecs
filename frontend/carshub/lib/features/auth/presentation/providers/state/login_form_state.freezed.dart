...
class _$LoginFormStateImpl implements _LoginFormState {
  const _$LoginFormStateImpl({this.mobile = "", this.password = ""});
  ...
  @override
  String toString() {
    return 'LoginFormState(mobile: $mobile, password: $password)';
  }
...
abstract class _LoginFormState implements LoginFormState {
  const factory _LoginFormState({final String mobile, final String password}) =
