...
abstract class $VerifyOtpRequestCopyWith<$Res> {
  ...
  @useResult
  $Res call({String contact, String password});
}
...
class _$VerifyOtpRequestImpl implements _VerifyOtpRequest {
  const _$VerifyOtpRequestImpl({this.contact = "", this.password = ""});
  ...
  @override
  String toString() {
    return 'VerifyOtpRequest(contact: $contact, password: $password)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, contact, password);
...
abstract class _VerifyOtpRequest implements VerifyOtpRequest {
  const factory _VerifyOtpRequest(
      {final String contact, final String password}) = _$VerifyOtpRequestImpl;
