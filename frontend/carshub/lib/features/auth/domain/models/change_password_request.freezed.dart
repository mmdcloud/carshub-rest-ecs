...
class _$ChangePasswordRequestImpl implements _ChangePasswordRequest {
  const _$ChangePasswordRequestImpl({this.contact = "", this.password = ""});
  ...
  @override
  String toString() {
    return 'ChangePasswordRequest(contact: $contact, password: $password)';
  }
...
abstract class _ChangePasswordRequest implements ChangePasswordRequest {
  const factory _ChangePasswordRequest(
      {final String contact,
      final String password}) = _$ChangePasswordRequestImpl;
