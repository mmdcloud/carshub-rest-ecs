...
abstract class $BrandCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String name, String countryOfOrigin});
}
...
class _$BrandImpl implements _Brand {
  const _$BrandImpl({this.id = "", this.name = "", this.countryOfOrigin = ""});
  ...
  @override
  String toString() {
    return 'Brand(id: $id, name: $name, countryOfOrigin: $countryOfOrigin)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, countryOfOrigin);
...
abstract class _Brand implements Brand {
  const factory _Brand(
      {final String id,
      final String name,
      final String countryOfOrigin}) = _$BrandImpl;
